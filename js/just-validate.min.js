...
function (e) {
  ...
  f.prototype = {
    ...
    defaultMessages: {
      ...
      email: "Пожалуйста, введите действующий адрес Email",
      ...
      strength: "Пароль должен содержать как минимум одну заглавную букву, одну строчную букву и одну цифру.",
      "function": "Телефон недействительный"
    },
